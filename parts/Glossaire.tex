...
\newacronym{ATAC-seq}{ATAC-seq}{Assay for Transposase-Accessible Chromatin sequencing}
\newacronym{CAGE}{CAGE}{Cap Analysis of Gene Expression}
\newacronym{ChIP-seq}{ChIP-seq}{Chromatin Immuno-Precipitation followed by sequencing ou Immunoprécipitation de la Chromatine suivie de séquençage}
...
\newacronym{eRNA}{eRNA}{enhancer Ribo-Nucleic Acid ou Acide Ribo-Nucléique produit par les éléments amplificateurs de l'expression}
...
\newacronym{SHH}{\textit{SHH}}{Sonic HedgeHog}
...
description={élément \textit{cis}-régulateur de l'expression d'un gène dont l'activité participe à l'initiation et/ou l'amplification de la transcription (enhancer en anglais)}}
 
\newglossaryentry{inhibiteur}{
name={inhibiteur}, plural={inhibiteurs},
description={élément \textit{cis}-régulateur de l'expression d'un gène qui participe à réduire sa transcription}}
...
% in vivo; in situ, in vitro,  de novo, a priori, a posteriori
